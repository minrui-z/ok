...
export const photos = {
  ...
  mit: mapPhoto("mit-great-dome.jpg", "MIT Killian Court 與 Great Dome", "Beyond My Ken／Wikimedia Commons · CC BY-SA 4.0", "https://commons.wikimedia.org/wiki/File:2017_Maclaurin_Buildings_(MIT_Building_10)_and_Great_Dome.jpg"),
  harvard: mapPhoto("harvard-yard.jpg", "Harvard Yard 與 Widener Library", "David Adam Kess／Wikimedia Commons · CC BY-SA 4.0", "https://commons.wikimedia.org/wiki/File:Harvard_University,._November,_2019._pic.bb8.jpg"),
};
...
export const tripDays: TripDay[] = [
  ...
  {
    id: "sep-02", date: "9/2", isoDate: "2026-09-02", weekday: "週三", location: "Back Bay / Fenway", title: "抵達 Boston 與 Red Sox", note: "下午的球賽以 Boston 當地日期顯示；台灣已是 9/3 凌晨。", color: "#287f8d", kind: "city",
    activities: [
      ...
      { id: "sep02-copley", timeLabel: "10:55", start: "2026-09-02T10:55:00-04:00", timezone: "America/New_York", title: "Copley Square 早午餐", detail: "在 Flour 或 Tatte 用餐，散步只留在飯店周邊。", icon: "food", category: "sight", priority: "recommended", durationMin: 65, coordinates: [42.3493, -71.0782], place: "Boston Public Library", photo: photos.bpl, outdoors: true, travelFromPrevious: travel("walk", "Hynes→Copley Square", 8, 12), rainAlternative: rain("sep02-copley-rain", "Boston Public Library 與 Prudential Center", "先看 Bates Hall 與館內壁畫，再走室內連通空間回飯店。", [42.3493, -71.0782], "Boston Public Library", photos.bpl) },
      { id: "sep02-rest", timeLabel: "12:15", start: "2026-09-02T12:15:00-04:00", timezone: "America/New_York", title: "回飯店休息", detail: "提早詢問房況；若還不能入住，就在飯店公共空間休息。", icon: "hotel", category: "stay", priority: "essential", durationMin: 135, coordinates: [42.3472, -71.0797], place: "Boston Marriott Copley Place", travelFromPrevious: travel("walk", "Copley Square→飯店", 6, 15) },
      { id: "sep07-arrive", timeLabel: "14:55", start: "2026-09-02T14:55:00-04:00", timezone: "America/New_York", title: "前往 Fenway Park", detail: "球票已買；15:20 左右抵達，預留安檢、找座位與買食物時間。", icon: "ticket", category: "transit", priority: "essential", durationMin: 65, coordinates: [42.3467, -71.0972], place: "Fenway Park", photo: photos.fenway, ticketed: true, fixed: true, travelFromPrevious: travel("transit", "Copley→Fenway Park", 20, 25, "可搭 Green Line 至 Kenmore，再步行進場") },
      { id: "sep07-game", timeLabel: "16:10", start: "2026-09-02T16:10:00-04:00", timezone: "America/New_York", title: "Red Sox vs. Mariners", detail: "Boston 當地 9/2 16:10 開賽；台灣時間是 9/3 04:10。球票已購買。", icon: "trophy", category: "sight", priority: "essential", durationMin: 210, coordinates: [42.3467, -71.0972], place: "Fenway Park", photo: photos.fenway, ticketed: true, fixed: true, outdoors: true, officialUrl: "https://www.mlb.com/gameday/824717", officialLabel: "MLB 場次", travelFromPrevious: travel("indoor", "球場入口→座位", 10, 20) },
      { id: "sep02-dinner", timeLabel: "19:50", start: "2026-09-02T19:50:00-04:00", timezone: "America/New_York", title: "Fenway 賽後晚餐", detail: "依實際散場時間選 Eventide 或 Time Out Market；太累就直接回飯店。", icon: "food", category: "food", priority: "recommended", durationMin: 90, coordinates: [42.3454, -71.0986], place: "Fenway", travelFromPrevious: travel("walk", "Fenway Park→晚餐", 10, 20, "散場人潮可能再多 10 分鐘") },
    ],
  },
  {
    id: "sep-03", date: "9/3", isoDate: "2026-09-03", weekday: "週四", location: "Cambridge", title: "MIT 與 Harvard", note: "兩校以 Red Line 串接，傍晚回 Back Bay。", color: "#a64b45", kind: "city",
    activities: [
      { id: "sep03-common", timeLabel: "09:15", start: "2026-09-03T09:15:00-04:00", timezone: "America/New_York", title: "MIT 校園", detail: "從 Welcome Center 出發，看 Stata Center、Infinite Corridor、Killian Court 與 Great Dome。", icon: "landmark", category: "sight", priority: "essential", durationMin: 150, coordinates: [42.3623, -71.0862], place: "MIT Welcome Center", photo: photos.mit, officialUrl: "https://www.mit.edu/visitmit/", officialLabel: "MIT 參觀資訊", outdoors: true, travelFromPrevious: travel("transit", "Copley→Kendall/MIT", 30, 20, "Green Line 到 Park Street，轉 Red Line 至 Kendall/MIT"), rainAlternative: rain("sep03-common-rain", "MIT Museum", "把校園戶外步行縮短，改到 MIT Museum 看展。", [42.3621, -71.0977], "MIT Museum", photos.mit) },
      { id: "sep03-faneuil", timeLabel: "12:15", start: "2026-09-03T12:15:00-04:00", timezone: "America/New_York", title: "Harvard Square 午餐", detail: "先吃午餐，再到 Smith Campus Center 的 Harvard Visitor Center。", icon: "food", category: "food", priority: "recommended", durationMin: 60, coordinates: [42.3734, -71.1190], place: "Harvard Square", travelFromPrevious: travel("transit", "Kendall/MIT→Harvard", 12, 18, "搭 Red Line 直達 Harvard 站") },
      { id: "sep03-old-north", timeLabel: "13:30", start: "2026-09-03T13:30:00-04:00", timezone: "America/New_York", title: "Harvard Yard", detail: "從 Visitor Center 依官方自助路線走 Harvard Yard、John Harvard Statue 與 Widener Library。", icon: "landmark", category: "sight", priority: "essential", durationMin: 90, coordinates: [42.3744, -71.1169], place: "Harvard Yard", photo: photos.harvard, officialUrl: "https://www.harvard.edu/visit/tours/", officialLabel: "Harvard 導覽", outdoors: true, travelFromPrevious: travel("walk", "Harvard Square→Harvard Yard", 8, 10), rainAlternative: rain("sep03-old-north-rain", "Harvard Art Museums", "把戶外校園步行改成室內館藏，保留 Harvard 校園停留。", [42.3742, -71.1142], "Harvard Art Museums", photos.harvard) },
      { id: "sep03-uss", timeLabel: "15:15", start: "2026-09-03T15:15:00-04:00", timezone: "America/New_York", title: "Harvard Art Museums", detail: "免費入館；若想留更多體力，可改在 Harvard Square 喝咖啡。", icon: "landmark", category: "sight", priority: "optional", durationMin: 90, coordinates: [42.3742, -71.1142], place: "Harvard Art Museums", photo: photos.harvard, officialUrl: "https://harvardartmuseums.org/visit", officialLabel: "參觀資訊", travelFromPrevious: travel("walk", "Harvard Yard→Harvard Art Museums", 8, 12) },
      { id: "sep03-apsa-event", timeLabel: "17:15", start: "2026-09-03T17:15:00-04:00", timezone: "America/New_York", title: "回 Back Bay", detail: "回飯店休息；晚餐與 APSA 晚間活動依體力決定。", icon: "train", category: "transit", priority: "recommended", durationMin: 45, coordinates: [42.3472, -71.0797], place: "Boston Marriott Copley Place", travelFromPrevious: travel("transit", "Harvard→Copley", 35, 20, "Red Line 到 Park Street，轉 Green Line 到 Copley") },
    ],
  },
  {
  ...
  {
    id: "sep-07", date: "9/7", isoDate: "2026-09-07", weekday: "週一", location: "Historic Boston", title: "Freedom Trail", note: "從 Boston Common 走到 Charlestown，Quincy Market 排在午餐前。", color: "#c46b42", kind: "city",
    activities: [
      { id: "sep07-fens", timeLabel: "09:00", start: "2026-09-07T09:00:00-04:00", timezone: "America/New_York", title: "Boston Common 至 Quincy Market", detail: "沿紅磚線走 State House、Granary、Old South Meeting House 與 Old State House，抵達 Quincy Market。", icon: "walk", category: "sight", priority: "essential", durationMin: 180, coordinates: [42.3550, -71.0656], place: "Boston Common Visitor Center", photo: photos.freedom, officialUrl: "https://www.thefreedomtrail.org/visit", officialLabel: "Freedom Trail", outdoors: true, travelFromPrevious: travel("transit", "Copley→Boston Common", 20, 15, "搭 Green Line 到 Park Street"), rainAlternative: rain("sep07-mfa-rain", "Old State House 與 Quincy Market", "縮短戶外步行，改看 Old State House 室內展覽，再到 Quincy Market。", [42.3588, -71.0575], "Old State House", photos.oldStateHouse) },
      { id: "sep07-brunch", timeLabel: "12:00", start: "2026-09-07T12:00:00-04:00", timezone: "America/New_York", title: "Quincy Market 與 North End", detail: "在 Quincy Market 吃午餐，再走 Paul Revere House、Hanover Street 與 Old North Church。", icon: "food", category: "sight", priority: "essential", durationMin: 165, coordinates: [42.3600, -71.0563], place: "Quincy Market", photo: photos.faneuil, officialUrl: "https://faneuilhallmarketplace.com/", officialLabel: "官方資訊", outdoors: true, travelFromPrevious: travel("walk", "Old State House→Quincy Market", 8, 12), rainAlternative: { ...rain("sep07-market-rain", "Quincy Market 與 Old North Church", "保留食品廊、教堂與室內歷史空間，減少巷弄步行。", [42.3600, -71.0563], "Quincy Market", photos.faneuil), officialUrl: "https://faneuilhallmarketplace.com/", officialLabel: "官方資訊" } },
      { id: "sep07-dinner", timeLabel: "15:00", start: "2026-09-07T15:00:00-04:00", timezone: "America/New_York", title: "Charlestown 與 USS Constitution", detail: "越過 Charlestown Bridge 到 Navy Yard；備妥附照片證件，依當日公告決定是否登艦。", icon: "ship", category: "sight", priority: "recommended", durationMin: 135, coordinates: [42.3725, -71.0554], place: "USS Constitution", photo: photos.uss, officialUrl: "https://www.nps.gov/bost/learn/historyculture/ussconst.htm", officialLabel: "NPS 參觀資訊", outdoors: true, travelFromPrevious: travel("walk", "Old North Church→Charlestown Navy Yard", 20, 15, "經 Charlestown Bridge"), rainAlternative: { ...rain("sep07-uss-rain", "USS Constitution Museum", "改看船塢旁的室內博物館，依現場公告決定是否登艦。", [42.3737, -71.0551], "USS Constitution Museum", photos.uss), officialUrl: "https://ussconstitutionmuseum.org/visit/", officialLabel: "參觀資訊" } },
    ],
  },
  {
...
export const restaurantGroups: RestaurantGroup[] = [
  ...
  {
    id: "north-end", title: "North End", dayIds: ["sep-07"],
    restaurants: [
  ...
  {
    id: "fenway", title: "Fenway", dayIds: ["sep-02", "sep-04"],
    restaurants: [
  ...
  },
  {
    ...
    restaurants: [
      ...
      { id: "ledger", name: "Ledger", area: "Downtown Salem", cuisine: "New American", price: "$$$", reason: "週日可預約，適合多人用餐。", address: "125 Washington St, Salem", officialUrl: "https://www.ledgersalem.com/", reservationLabel: "訂位資訊" },
...
export const bookingItems: BookingItem[] = [
  ...
  { id: "apsa", title: "APSA 報到與發表資料", kind: "conference", forDate: "9/4、9/5", recommendedBy: "2026-08-20", dayId: "sep-04", detail: "確認兩場的房間、時間、註冊與投影片備份；確切時間補進行程後，再確認交通與提早抵達時間。", url: "https://connect.apsanet.org/apsa2026/", actionLabel: "APSA 2026" },
  ...
  { id: "red-sox", title: "Red Sox vs Mariners · 已購票", kind: "ticket", forDate: "Boston 9/2 16:10／台灣 9/3 04:10", recommendedBy: "2026-08-20", dayId: "sep-02", detail: "MLB 官方場次 824717；出發當天只需再看是否延後、延期或取消。", url: "https://www.mlb.com/gameday/824717", actionLabel: "MLB 場次" },
