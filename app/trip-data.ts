...
export const tripDays: TripDay[] = [
  {
    ...
    activities: [
      ...
      { id: "sep01-sea", timeLabel: "16:10", start: "2026-09-01T16:10:00-07:00", timezone: "America/Los_Angeles", title: "抵達 Seattle", detail: "完成入境、領取／重新托運行李與安檢，預留 2–3 小時。", icon: "luggage", category: "transit", priority: "essential", durationMin: 140, coordinates: [47.4502, -122.3088], place: "Seattle–Tacoma International Airport", fixed: true },
      { id: "sep01-dinner", timeLabel: "18:30", start: "2026-09-01T18:30:00-07:00", timezone: "America/Los_Angeles", title: "機場晚餐", detail: "Beecher’s、Floret 或 Salty’s at the SEA；晚餐後在航廈休息。", icon: "food", category: "food", priority: "recommended", durationMin: 75, coordinates: [47.4502, -122.3088], place: "SEA Airport" },
      { id: "sep01-sea-bos", timeLabel: "23:00", start: "2026-09-01T23:00:00-07:00", timezone: "America/Los_Angeles", title: "SEA → BOS", detail: "21:30 前回到登機門，保留航廈移動緩衝。", icon: "plane", category: "flight", priority: "essential", durationMin: 280, coordinates: [47.4502, -122.3088], place: "SEA Airport", fixed: true },
    ],
  },
  {
    ...
    activities: [
      ...
      { id: "sep02-hotel", timeLabel: "09:30", start: "2026-09-02T09:30:00-04:00", timezone: "America/New_York", title: "飯店寄放行李", detail: "Boston Marriott Copley Place，110 Huntington Ave。", icon: "hotel", category: "stay", priority: "essential", durationMin: 20, coordinates: [42.3472, -71.0797], place: "Boston Marriott Copley Place", fixed: true },
      { id: "sep02-apsa", timeLabel: "10:00", start: "2026-09-02T10:00:00-04:00", timezone: "America/New_York", title: "APSA 報到", detail: "到 Hynes 領證並確認 9/4、9/5 的房間與樓層。", icon: "talk", category: "conference", priority: "essential", durationMin: 40, coordinates: [42.3481, -71.0837], place: "Hynes Convention Center", fixed: true },
      { id: "sep02-copley", timeLabel: "11:00", start: "2026-09-02T11:00:00-04:00", timezone: "America/New_York", title: "Copley Square 與午餐", detail: "Flour 或 Tatte 早午餐，接著看 BPL、Trinity Church 與 Newbury Street。", icon: "food", category: "sight", priority: "recommended", durationMin: 150, coordinates: [42.3493, -71.0782], place: "Boston Public Library", photo: photos.bpl, outdoors: true, rainAlternative: rain("sep02-copley-rain", "Boston Public Library 與 Prudential Center", "先看 Bates Hall 與館內壁畫，再走連通室內空間回飯店。", [42.3493, -71.0782], "Boston Public Library", photos.bpl) },
      { id: "sep02-rest", timeLabel: "16:00", start: "2026-09-02T16:00:00-04:00", timezone: "America/New_York", title: "入住與補眠", detail: "小睡 60–90 分鐘，晚上再出門吃飯。", icon: "hotel", category: "stay", priority: "essential", durationMin: 120, coordinates: [42.3472, -71.0797], place: "Boston Marriott Copley Place" },
      { id: "sep02-dinner", timeLabel: "19:00", start: "2026-09-02T19:00:00-04:00", timezone: "America/New_York", title: "Back Bay 晚餐", detail: "Atlantic Fish 為首選；餐後直接回飯店早睡。", icon: "food", category: "food", priority: "recommended", durationMin: 90, coordinates: [42.3494, -71.0810], place: "Atlantic Fish Company" },
    ],
  },
  {
    ...
    activities: [
      { id: "sep03-common", timeLabel: "09:00", start: "2026-09-03T09:00:00-04:00", timezone: "America/New_York", title: "Boston Common 起走", detail: "State House、Granary、Old South Meeting House、Old State House。", icon: "walk", category: "sight", priority: "essential", durationMin: 150, coordinates: [42.3550, -71.0656], place: "Boston Common Visitor Center", photo: photos.freedom, outdoors: true, rainAlternative: rain("sep03-common-rain", "Old State House", "把戶外步行縮短，改看 Old State House 的室內展覽。", [42.3588, -71.0575], "Old State House") },
      { id: "sep03-faneuil", timeLabel: "11:30", start: "2026-09-03T11:30:00-04:00", timezone: "America/New_York", title: "Faneuil Hall 與 North End", detail: "午餐從 North End 候補清單挑一間。", icon: "food", category: "food", priority: "recommended", durationMin: 110, coordinates: [42.3600, -71.0563], place: "Faneuil Hall", photo: photos.faneuil, outdoors: true, rainAlternative: rain("sep03-market-rain", "Boston Public Market", "在室內市場吃午餐，再從 Haymarket 進 North End。", [42.3610, -71.0570], "Boston Public Market") },
      { id: "sep03-old-north", timeLabel: "13:30", start: "2026-09-03T13:30:00-04:00", timezone: "America/New_York", title: "Paul Revere 與 Old North Church", detail: "離開前到 Hanover Street 買 cannoli。", icon: "landmark", category: "sight", priority: "recommended", durationMin: 80, coordinates: [42.3663, -71.0544], place: "Old North Church", photo: photos.oldNorth, outdoors: true, rainAlternative: rain("sep03-old-north-rain", "Old North Church 室內參觀", "保留教堂與歷史展區，減少巷弄步行。", [42.3663, -71.0544], "Old North Church", photos.oldNorth) },
      { id: "sep03-uss", timeLabel: "15:00", start: "2026-09-03T15:00:00-04:00", timezone: "America/New_York", title: "USS Constitution", detail: "備妥附照片證件；體力不足可留在 North End。", icon: "ship", category: "sight", priority: "optional", durationMin: 100, coordinates: [42.3725, -71.0554], place: "USS Constitution", photo: photos.uss, outdoors: true, rainAlternative: rain("sep03-uss-rain", "USS Constitution Museum", "改看船塢旁的室內博物館，依現場公告決定是否登艦。", [42.3737, -71.0551], "USS Constitution Museum", photos.uss) },
      { id: "sep03-apsa-event", timeLabel: "18:00", start: "2026-09-03T18:00:00-04:00", timezone: "America/New_York", title: "APSA 活動或回 Back Bay", detail: "依會議日程決定；沒有活動就回飯店附近晚餐。", icon: "talk", category: "conference", priority: "optional", durationMin: 120, coordinates: [42.3481, -71.0837], place: "Hynes Convention Center", fixed: true },
    ],
  },
  {
    ...
    activities: [
      ...
      { id: "sep04-talk", timeLabel: "上午", timezone: "America/New_York", title: "APSA 發表", detail: "確切時間未定；完成後可在下一站模式手動勾選。", icon: "talk", category: "conference", priority: "essential", durationMin: 90, coordinates: [42.3481, -71.0837], place: "Hynes Convention Center", vague: true, fixed: true },
      { id: "sep04-gardner", timeLabel: "14:30", start: "2026-09-04T14:30:00-04:00", timezone: "America/New_York", title: "Isabella Stewart Gardner Museum", detail: "預約定時票，停留約 2 小時。", icon: "landmark", category: "sight", priority: "essential", durationMin: 120, coordinates: [42.3389, -71.0990], place: "Isabella Stewart Gardner Museum", photo: photos.gardner, ticketed: true, fixed: true, officialUrl: "https://www.gardnermuseum.org/visit", officialLabel: "門票" },
      { id: "sep04-fens", timeLabel: "17:00", start: "2026-09-04T17:00:00-04:00", timezone: "America/New_York", title: "Back Bay Fens", detail: "沿 Fenway 綠地散步，再回 Back Bay。", icon: "walk", category: "sight", priority: "optional", durationMin: 60, coordinates: [42.3413, -71.0970], place: "Back Bay Fens", photo: photos.fens, outdoors: true, rainAlternative: rain("sep04-mfa-rain", "Museum of Fine Arts", "改到 MFA 看一個館區，避免在雨中走 Fens。", [42.3394, -71.0940], "Museum of Fine Arts Boston") },
      { id: "sep04-dinner", timeLabel: "18:30", start: "2026-09-04T18:30:00-04:00", timezone: "America/New_York", title: "Fenway 晚餐", detail: "從 Fenway 候補清單選一間，訂位後再調整離館時間。", icon: "food", category: "food", priority: "recommended", durationMin: 90, coordinates: [42.3458, -71.1008], place: "Eastern Standard" },
    ],
  },
  {
    ...
    activities: [
      { id: "sep05-bpl", timeLabel: "09:15", start: "2026-09-05T09:15:00-04:00", timezone: "America/New_York", title: "Boston Public Library", detail: "Bates Hall、壁畫與庭院。", icon: "landmark", category: "sight", priority: "essential", durationMin: 90, coordinates: [42.3493, -71.0782], place: "Boston Public Library Central", photo: photos.bpl },
      { id: "sep05-newbury", timeLabel: "11:00", start: "2026-09-05T11:00:00-04:00", timezone: "America/New_York", title: "Newbury Street", detail: "午餐吃輕一些，12:30 前回飯店。", icon: "shop", category: "shopping", priority: "optional", durationMin: 80, coordinates: [42.3503, -71.0810], place: "Newbury Street", photo: photos.newbury, outdoors: true, rainAlternative: rain("sep05-pru-rain", "Prudential Center", "改走室內商場與 Eataly，從連通道回飯店。", [42.3472, -71.0825], "Prudential Center") },
      ...
      { id: "sep05-talk", timeLabel: "下午", timezone: "America/New_York", title: "APSA 發表", detail: "確切時間未定；結束後可在下一站模式手動勾選。", icon: "talk", category: "conference", priority: "essential", durationMin: 90, coordinates: [42.3481, -71.0837], place: "Hynes Convention Center", vague: true, fixed: true },
      { id: "sep05-dinner", timeLabel: "19:00", start: "2026-09-05T19:00:00-04:00", timezone: "America/New_York", title: "慶祝晚餐", detail: "Krasi 為首選，訂不到再看 Back Bay 候補。", icon: "trophy", category: "food", priority: "recommended", durationMin: 120, coordinates: [42.3494, -71.0826], place: "Krasi" },
    ],
  },
  {
    ...
    activities: [
      { id: "sep06-train", timeLabel: "07:45", start: "2026-09-06T07:45:00-04:00", timezone: "America/New_York", title: "前往 North Station", detail: "Orange Line 轉 Newburyport／Rockport Line，出發前查當日時刻。", icon: "train", category: "transit", priority: "essential", durationMin: 100, coordinates: [42.3664, -71.0623], place: "North Station", fixed: true },
      { id: "sep06-visitor", timeLabel: "09:30", start: "2026-09-06T09:30:00-04:00", timezone: "America/New_York", title: "Salem Visitor Center", detail: "先拿地圖，再走到 Peabody Essex Museum。", icon: "landmark", category: "sight", priority: "recommended", durationMin: 25, coordinates: [42.5229, -70.8955], place: "Salem Regional Visitor Center" },
      { id: "sep06-pem", timeLabel: "10:00", start: "2026-09-06T10:00:00-04:00", timezone: "America/New_York", title: "Peabody Essex Museum", detail: "停留約 2 小時；雨天可把下午更多時間留在館內。", icon: "landmark", category: "sight", priority: "essential", durationMin: 120, coordinates: [42.5215, -70.8928], place: "Peabody Essex Museum", photo: photos.pem, fixed: true, officialUrl: "https://www.pem.org/visit", officialLabel: "參觀資訊" },
      { id: "sep06-lunch", timeLabel: "12:30", start: "2026-09-06T12:30:00-04:00", timezone: "America/New_York", title: "Salem 午餐", detail: "從 Salem 候補清單選一間，週日先訂位。", icon: "food", category: "food", priority: "recommended", durationMin: 75, coordinates: [42.5205, -70.8917], place: "Downtown Salem" },
      { id: "sep06-memorial", timeLabel: "14:00", start: "2026-09-06T14:00:00-04:00", timezone: "America/New_York", title: "Witch Trials Memorial", detail: "接著在歷史步行導覽和 Witch House 之間擇一。", icon: "walk", category: "sight", priority: "recommended", durationMin: 90, coordinates: [42.5213, -70.8914], place: "Salem Witch Trials Memorial", photo: photos.witch, outdoors: true, rainAlternative: rain("sep06-history-rain", "Witch House 與 PEM 延長參觀", "把戶外導覽換成 Witch House，並把 PEM 停留延長一小時。", [42.5219, -70.8988], "The Witch House at Salem") },
      { id: "sep06-gables", timeLabel: "16:00", start: "2026-09-06T16:00:00-04:00", timezone: "America/New_York", title: "Seven Gables 與 Derby Wharf", detail: "看完港口後依體力搭 17:30–18:30 的車回 Boston。", icon: "waves", category: "sight", priority: "optional", durationMin: 90, coordinates: [42.5209, -70.8865], place: "The House of the Seven Gables", photo: photos.gables, outdoors: true, rainAlternative: rain("sep06-gables-rain", "House of the Seven Gables 室內導覽", "保留室內導覽，取消 Derby Wharf 港邊步行。", [42.5209, -70.8865], "The House of the Seven Gables", photos.gables) },
    ],
  },
  {
    ...
    activities: [
      { id: "sep07-fens", timeLabel: "09:00", start: "2026-09-07T09:00:00-04:00", timezone: "America/New_York", title: "Emerald Necklace", detail: "Back Bay Fens 輕鬆散步，為下午球賽留體力。", icon: "walk", category: "sight", priority: "optional", durationMin: 60, coordinates: [42.3413, -71.0970], place: "Back Bay Fens", photo: photos.fens, outdoors: true, rainAlternative: rain("sep07-mfa-rain", "Museum of Fine Arts", "取消晨間散步，改看 MFA 一個館區。", [42.3394, -71.0940], "Museum of Fine Arts Boston") },
      { id: "sep07-brunch", timeLabel: "10:30", start: "2026-09-07T10:30:00-04:00", timezone: "America/New_York", title: "Fenway 早午餐", detail: "從 Fenway 候補清單挑一間，預留排隊時間。", icon: "coffee", category: "food", priority: "recommended", durationMin: 75, coordinates: [42.3447, -71.1005], place: "Fenway" },
      { id: "sep07-arrive", timeLabel: "12:15", start: "2026-09-07T12:15:00-04:00", timezone: "America/New_York", title: "提早抵達 Fenway Park", detail: "逛 Jersey Street 與球隊商店。", icon: "ticket", category: "sight", priority: "essential", durationMin: 70, coordinates: [42.3467, -71.0972], place: "Fenway Park", photo: photos.fenway, ticketed: true, fixed: true },
      { id: "sep07-game", timeLabel: "13:35", start: "2026-09-07T13:35:00-04:00", timezone: "America/New_York", title: "Red Sox vs. Angels", detail: "購票後再以 MLB 官方賽程確認開賽時間；若官方延期，再改安排室內備案。", icon: "trophy", category: "sight", priority: "essential", durationMin: 210, coordinates: [42.3467, -71.0972], place: "Fenway Park", photo: photos.fenway, ticketed: true, fixed: true, outdoors: true, officialUrl: "https://www.mlb.com/redsox/tickets/single-game-tickets", officialLabel: "官方售票" },
      { id: "sep07-dinner", timeLabel: "17:30", start: "2026-09-07T17:30:00-04:00", timezone: "America/New_York", title: "賽後晚餐", detail: "看實際散場時間，再從 Fenway 候補清單挑一間。", icon: "food", category: "food", priority: "recommended", durationMin: 90, coordinates: [42.3454, -71.0986], place: "Fenway" },
    ],
  },
  {
    ...
    activities: [
      { id: "sep08-car", timeLabel: "08:00", start: "2026-09-08T08:00:00-04:00", timezone: "America/New_York", title: "Back Bay 取車", detail: "100 Clarendon Street 一帶取車，拍照記錄車況後出發。", icon: "car", category: "transit", priority: "essential", durationMin: 120, coordinates: [42.3473, -71.0758], place: "100 Clarendon Street", fixed: true },
      { id: "sep08-breakers", timeLabel: "10:00", start: "2026-09-08T10:00:00-04:00", timezone: "America/New_York", title: "The Breakers", detail: "預約定時票，語音導覽約 90 分鐘。", icon: "landmark", category: "sight", priority: "essential", durationMin: 100, coordinates: [41.4699, -71.2989], place: "The Breakers", photo: photos.breakers, ticketed: true, fixed: true, officialUrl: "https://www.newportmansions.org/plan-a-visit/", officialLabel: "門票" },
      { id: "sep08-cliff", timeLabel: "11:45", start: "2026-09-08T11:45:00-04:00", timezone: "America/New_York", title: "Cliff Walk 北段", detail: "從 Ruggles Avenue 走到 40 Steps；遇封閉依現場繞道。", icon: "walk", category: "sight", priority: "recommended", durationMin: 75, coordinates: [41.4740, -71.2980], place: "Cliff Walk 40 Steps", photo: photos.cliff, outdoors: true, rainAlternative: rain("sep08-marble-rain", "Marble House", "把海岸步道換成另一座鍍金年代宅邸。", [41.4620, -71.3051], "Marble House") },
      { id: "sep08-lunch", timeLabel: "13:15", start: "2026-09-08T13:15:00-04:00", timezone: "America/New_York", title: "Newport 午餐", detail: "從 Newport 候補清單選一間，接著逛 Bowen’s Wharf。", icon: "food", category: "food", priority: "recommended", durationMin: 100, coordinates: [41.4862, -71.3155], place: "Bowen's Wharf" },
      { id: "sep08-ocean", timeLabel: "16:00", start: "2026-09-08T16:00:00-04:00", timezone: "America/New_York", title: "Ocean Drive", detail: "沿海岸開車，在 Brenton Point 短停後回 Boston。", icon: "car", category: "sight", priority: "optional", durationMin: 75, coordinates: [41.4497, -71.3420], place: "Brenton Point State Park", photo: photos.ocean, outdoors: true, rainAlternative: rain("sep08-art-rain", "Newport Art Museum", "取消 Ocean Drive 停留，改看 Newport Art Museum。", [41.4885, -71.3089], "Newport Art Museum") },
      { id: "sep08-return", timeLabel: "17:15", start: "2026-09-08T17:15:00-04:00", timezone: "America/New_York", title: "回 Boston", detail: "避開疲勞駕駛，晚餐回 Copley 再吃。", icon: "car", category: "transit", priority: "essential", durationMin: 130, coordinates: [42.3473, -71.0758], place: "Back Bay", fixed: true },
    ],
  },
  {
    ...
    activities: [
      { id: "sep09-nb", timeLabel: "09:00", start: "2026-09-09T09:00:00-04:00", timezone: "America/New_York", title: "New Balance 世界總部與旗艦店", detail: "拍攝總部外觀，在 Boston Landing 旗艦店購物；不進入辦公區。", icon: "store", category: "shopping", priority: "essential", durationMin: 75, coordinates: [42.3571, -71.1445], place: "New Balance World Headquarters", photo: photos.newBalance, officialUrl: "https://www.newbalance.com/stores/", officialLabel: "門市資訊" },
      { id: "sep09-lexington", timeLabel: "10:45", start: "2026-09-09T10:45:00-04:00", timezone: "America/New_York", title: "Lexington Battle Green", detail: "短停看 Battle Green，再沿 MA-2A 前往 Concord。", icon: "landmark", category: "sight", priority: "recommended", durationMin: 55, coordinates: [42.4494, -71.2306], place: "Lexington Battle Green", photo: photos.lexington, outdoors: true, rainAlternative: rain("sep09-concord-museum-rain", "Concord Museum", "取消 Battle Green 戶外停留，直接到 Concord Museum。", [42.4570, -71.3421], "Concord Museum") },
      { id: "sep09-concord-lunch", timeLabel: "12:15", start: "2026-09-09T12:15:00-04:00", timezone: "America/New_York", title: "Concord 午餐", detail: "從 Concord 候補清單挑一間。", icon: "food", category: "food", priority: "recommended", durationMin: 75, coordinates: [42.4604, -71.3489], place: "Concord Center" },
      { id: "sep09-bridge", timeLabel: "14:00", start: "2026-09-09T14:00:00-04:00", timezone: "America/New_York", title: "Old North Bridge", detail: "走到橋邊與 Minute Man Visitor Center 周邊。", icon: "walk", category: "sight", priority: "essential", durationMin: 90, coordinates: [42.4692, -71.3507], place: "Old North Bridge", photo: photos.bridge, outdoors: true, rainAlternative: rain("sep09-orchard-rain", "Orchard House", "改看 Louisa May Alcott’s Orchard House 室內導覽。", [42.4597, -71.3347], "Louisa May Alcott's Orchard House") },
      { id: "sep09-walden", timeLabel: "16:00", start: "2026-09-09T16:00:00-04:00", timezone: "America/New_York", title: "Walden Pond", detail: "湖邊短走；若太累就提前回 Boston 還車。", icon: "waves", category: "sight", priority: "optional", durationMin: 70, coordinates: [42.4388, -71.3420], place: "Walden Pond State Reservation", photo: photos.walden, outdoors: true, rainAlternative: rain("sep09-museum-rain-2", "Concord Museum 延長參觀", "把 Walden Pond 改成完整看完 Concord Museum 的常設展。", [42.4570, -71.3421], "Concord Museum") },
      { id: "sep09-return", timeLabel: "17:30", start: "2026-09-09T17:30:00-04:00", timezone: "America/New_York", title: "回 Back Bay 還車", detail: "加滿油、保留收據，檢查座位與後車廂。", icon: "car", category: "transit", priority: "essential", durationMin: 90, coordinates: [42.3473, -71.0758], place: "Back Bay", fixed: true },
    ],
  },
  {
    ...
    activities: [
      ...
      { id: "sep10-last", timeLabel: "10:45", start: "2026-09-10T10:45:00-04:00", timezone: "America/New_York", title: "最後半天", detail: "依體力選 Newbury Street、Boston Public Garden 或 View Boston。", icon: "camera", category: "sight", priority: "recommended", durationMin: 180, coordinates: [42.3519, -71.0704], place: "Boston Public Garden", photo: photos.skyline, outdoors: true, rainAlternative: rain("sep10-rain", "Boston Public Library 與 Prudential Center", "在 BPL、Prudential 與 Eataly 之間安排室內半日。", [42.3493, -71.0782], "Boston Public Library", photos.bpl) },
      { id: "sep10-lunch", timeLabel: "13:00", start: "2026-09-10T13:00:00-04:00", timezone: "America/New_York", title: "返程前午餐", detail: "從返程日候補挑一間，不安排需要久候的店。", icon: "food", category: "food", priority: "recommended", durationMin: 70, coordinates: [42.3475, -71.0825], place: "Prudential Center" },
      ...
      { id: "sep10-depart", timeLabel: "20:00", start: "2026-09-10T20:00:00-04:00", timezone: "America/New_York", title: "BOS → SEA", detail: "抵達 SEA 約 23:12，依轉機指標前往下一段登機門。", icon: "plane", category: "flight", priority: "essential", durationMin: 372, coordinates: [42.3656, -71.0096], place: "Boston Logan International Airport", fixed: true },
      { id: "sep11-depart", timeLabel: "9/11 02:00", start: "2026-09-11T02:00:00-07:00", timezone: "America/Los_Angeles", title: "SEA → TPE", detail: "在 SEA 轉機約 2 小時 48 分。", icon: "plane", category: "flight", priority: "essential", durationMin: 780, coordinates: [47.4502, -122.3088], place: "Seattle–Tacoma International Airport", fixed: true },
