...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    activities: [
      ...
      { id: "sep07-dinner", timeLabel: "15:00", start: "2026-09-07T15:00:00-04:00", timezone: "America/New_York", title: "Charlestown 與 USS Constitution", detail: "越過 Charlestown Bridge 到 Navy Yard；備妥附照片證件，依當日公告決定是否登艦。", icon: "ship", category: "sight", priority: "recommended", durationMin: 135, coordinates: [42.3725, -71.0554], place: "USS Constitution", photo: photos.uss, officialUrl: "https://www.nps.gov/bost/learn/historyculture/ussconst.htm", officialLabel: "NPS 參觀資訊", outdoors: true, travelFromPrevious: travel("walk", "Old North Church→Charlestown Navy Yard", 20, 15, "經 Charlestown Bridge"), rainAlternative: rain("sep07-uss-rain", "USS Constitution Museum", "改看船塢旁的室內博物館，依現場公告決定是否登艦。", [42.3737, -71.0551], "USS Constitution Museum", photos.uss) },
    ],
  },
  {
